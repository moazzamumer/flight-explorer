...
class GenAI:
    ...
    def get_parsed_input(self, text):
        system_prompt = "Given user text input, your task is to extract relevant travel information such as the trip_type (one-way or round), travel_date, return_date, origin, destination, travel_class (Economy, Business, or First), and number_of_passengers, and format it into JSON. \
